...
CustomWaterfallGraph::CustomWaterfallGraph(QWidget *parent, bool enableGrid, int gridDivisions, TimeInterval timeInterval)
    : WaterfallGraph(parent, enableGrid, gridDivisions, timeInterval), drawingStyle("default"), customDataColor(Qt::green), customGridColor(Qt::white), customBackgroundColor(Qt::black), useCustomColors(false), barWidth(8.0), pointSize(4.0), showDataPoints(true), showDataBars(false), showDataArea(false)
{
